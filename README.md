...
- Includes ChatMusic Studio for opening/saving ABC files, checking abcjs parser warnings, rendering it live, linking to external MusicXML/ABC converters, and opening detected scores in the Studio.
